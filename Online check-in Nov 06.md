...
- Created the initial paper structure in **Overleaf**, consisting of:
  ...
  - Evaluation  
  - Conclusion  
- Most of the implementation is completed — focus for the upcoming weeks:
  - Creating diagrams for clarity.  
  - Writing and refining the report text.  
...
**Next Steps:**
- Design a web portal for end users  
- Write report section on *Methodology*  
...
**Next Steps:**
- Work on GPIO trigger mechanism for sending push notifications  
- Write report sections on *Results* and *Discussion*  
